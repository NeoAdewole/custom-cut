...
// Phase 5 save output — before Phase 6 added copyVerticalAlign, titleTag, gradient, text styles.
const v2 = {
  save({ attributes }) {
    const {
...
// Phase 4 save output — before aria-roledescription and loading="lazy" were added.
export default [
  v2,
  {
    save({ attributes }) {
